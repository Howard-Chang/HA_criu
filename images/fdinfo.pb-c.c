...
static const ProtobufCFieldDescriptor file_entry__field_descriptors[20] =
{
  {
    "type",
    1,
...
static const ProtobufCEnumValue fd_types__enum_values_by_number[21] =
{
  { "UND", "FD_TYPES__UND", 0 },
  { "REG", "FD_TYPES__REG", 1 },
...
static const ProtobufCEnumValueIndex fd_types__enum_values_by_name[21] =
{
  { "AUTOFS_PIPE", 20 },
  { "CTL_TTY", 19 },
  { "EVENTFD", 6 },
