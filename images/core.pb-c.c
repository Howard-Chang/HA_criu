...
static const ProtobufCFieldDescriptor task_core_entry__field_descriptors[16] =
{
  {
    "task_state",
    1,
...
static const ProtobufCIntRange task_core_entry__number_ranges[2 + 1] =
{
  { 1, 0 },
  { 18, 15 },
  { 0, 16 }
...
const ProtobufCMessageDescriptor task_core_entry__descriptor =
{
  ...
  2,  task_core_entry__number_ranges,
